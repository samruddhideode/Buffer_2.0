...
class Data:
    ...
    def get_cutoff_marks(self):
        ...
        n = len(comp_allotment)
        self.cutoff_marks["Computer"]=comp_allotment[n-1][1]
        n = len(IT_allotment)
        self.cutoff_marks["IT"]=IT_allotment[n-1][1]
        n = len(mech_allotment)
        self.cutoff_marks["Mechanical"]=mech_allotment[n-1][1]
        n = len(elec_allotment)
        self.cutoff_marks["Electronics"]=elec_allotment_allotment[n-1][1]
